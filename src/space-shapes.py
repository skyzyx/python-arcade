...
class Shape:
    ...
    def __init__(self, x, y, width, height, angle, delta_x, delta_y, color):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
...
class Ellipse(Shape):
    ...
    def __init__(self, x, y, width, height, angle, delta_x, delta_y, color):
        ...
        super().__init__(x, y, width, height, angle, delta_x, delta_y, color)
...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for i in range(NUMBER_OF_SHAPES):
            ...
            if shape_type == 0:
                shape = Rectangle(
                    x, y, width, height, angle, d_x, d_y, (red, green, blue, alpha)
                )
            elif shape_type == 1:
                shape = Ellipse(
                    x, y, width, height, angle, d_x, d_y, (red, green, blue, alpha)
