...
def on_draw(delta_time):
    ...
    # print(f"X: {on_draw.center_x}, Y: {on_draw.center_y}")
...
# objects.
on_draw.center_x = random.randint(SCREEN_WIDTH // 2) # Initial position.
on_draw.center_y = random.randint(SCREEN_HEIGHT // 2) # Initial position.
on_draw.delta_x = random.randint(SCREEN_WIDTH // 2) # Controls speed.
on_draw.delta_y = random.randint(SCREEN_HEIGHT // 2) # Controls speed.

print(f"DeltaX: {on_draw.delta_x}")
print(f"DeltaY: {on_draw.delta_y}")
